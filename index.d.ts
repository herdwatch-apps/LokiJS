 ...
 * @implements LokiEventEmitter
 */
declare class DynamicView<E> extends LokiEventEmitter {
  name: string;
  collection: Collection<E>;
 ...
 */
declare class Collection<E> extends LokiEventEmitter {
  disableMeta: boolean;
  name: any;
  objType: string;
  data: E[];
  ...
  public setDisableEmitEventsStatus(enabled: boolean): void;
...
declare class _Collection<E> extends Collection<E> {}
...
declare namespace LokiConstructor {
  ...
  export class Collection<E = any> extends _Collection<E> {}
...
declare module '@herdwatch/lokijs' {
